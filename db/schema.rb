...
ActiveRecord::Schema.define(version: 2022_05_29_035923) do
  ...
  create_table "lightalumnis", id: false, force: :cascade do |t|
    t.string "full_name"
    t.string "first_name"
    t.string "middle_initial"
    t.string "middle_name"
  ...
  create_table "microecctests", id: false, force: :cascade do |t|
    t.string "full_name"
    t.string "first_name"
    t.string "middle_initial"
    t.string "middle_name"
